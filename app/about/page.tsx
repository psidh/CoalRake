  ...
  return (
    <div style={{ fontFamily: 'Ambit, sans-serif' }}>
      ...
      <div className="p-4 container mx-auto font-semibold my-4 px-6 md:px-16 md:py-10 text-justify">
        <h1 className="text-2xl md:text-4xl text-gray-800 font-bold my-8">
          About
        </h1>
        <section className="my-8">
          <h2 className="text-2xl md:text-4xl text-gray-800 font-semibold my-4">
            Problem Statement
          </h2>
          <p className="text-gray-600 text-xl md:text-2xl my-2">
            ...
            to waiting times for trains. CRN Coal Rake Navigators aims to
