  ...
  return (
    ...
    <div className="min-h-fit">
      <div className=" px-4 py-8 flex flex-col justify-center items-center">
        <div className="p-6">
          <h1 className="text-3xl font-semibold mb-4">Get Started as a Coal Operator</h1>
          ...
          <ul className="list-disc list-inside text-gray-700 mb-4">
            ...
            <li>Manage your coal production data for different mines and regions.</li>
            <li>Apply filters to analyze and visualize your data.</li>
            <li>Stay up-to-date with the latest coal industry trends and news.</li>
          </ul>
          ...
          <div className="mt-6">
            <a
              href="/login" target='_blank' // Replace with the actual signup page URL
